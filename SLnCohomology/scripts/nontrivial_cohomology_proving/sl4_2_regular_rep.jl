...
# H^5:
delta_4_11 = representing_matrix(Δ₄[1,1],p)
delta_4_12 = representing_matrix(Δ₄[1,2],p)
delta_4_13 = representing_matrix(Δ₄[1,3],p)
delta_4_21 = representing_matrix(Δ₄[2,1],p)
delta_4_22 = representing_matrix(Δ₄[2,2],p)
delta_4_23 = representing_matrix(Δ₄[2,3],p)
delta_4_31 = representing_matrix(Δ₄[3,1],p)
delta_4_32 = representing_matrix(Δ₄[3,2],p)
delta_4_33 = representing_matrix(Δ₄[3,3],p)
delta_4_perm = [
